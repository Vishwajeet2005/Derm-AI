    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:block lg:w-[55%] relative">
        ...
        <div className="absolute bottom-12 left-12 right-12 max-w-md">
          ...
          <p className="text-white/60 text-sm font-medium">â€” World Health Organization</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center py-12 px-8 sm:px-16 lg:px-20 bg-white dark:bg-slate-900 overflow-y-auto transition-colors">
        <div className="w-full max-w-sm mx-auto animate-fade-in-up" style={{ animationDelay: '0.1s', opacity: 0 }}>
          ...
          <h1 className="text-3xl font-light text-[#18181b] dark:text-white mb-2">Create your account</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 font-light mb-10">
            Start monitoring your skin health today.{' '}
            <Link to="/login" className="font-medium text-[#6b8c84] dark:text-teal-400 hover:text-[#52736b] dark:hover:text-teal-300 transition-colors">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-sm font-medium text-[#475569] dark:text-slate-300 mb-1.5">Full Name</label>
            ...
            <div>
              ...
              <select className="input-field" value={form.fitzpatrick_type} onChange={set('fitzpatrick_type')}>
                ...
                <option value="1">Type I â€” Very fair, always burns</option>
                <option value="2">Type II â€” Fair, usually burns</option>
                <option value="3">Type III â€” Medium, sometimes burns</option>
                <option value="4">Type IV â€” Olive, rarely burns</option>
                <option value="5">Type V â€” Brown, very rarely burns</option>
                <option value="6">Type VI â€” Dark brown, never burns</option>
              </select>
            </div>
